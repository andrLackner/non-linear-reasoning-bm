...
; Benchmark: 		cohencu_norm_inv3_1xlen4
...
; Testing invariant: 12*y00*z^3 + 6*x^2*z*z00 + 108*x*z + 60*y00*z^2 - 108*x^3 - 78*y*z^2 + 6*y*z^3 - 18*y00*z^2*z00 - 72*y00*z + 108*x00*z^2 - x^2*z*z00^2 - 6*z^2*z00 + 72*n*x^2*y*z^3 - 72*x^2*y - 6*n*x^2*y*z^4 + n*x^2*z^4*z00^2 - 18*x^2*y00*z00 + 18*y00*z*z00 + 72*y*z + 12*x^2*y00*z + 108*x^2*x00 + 72*x^2*y00 - z*z00^3 + 108*n*x^3*z^3 + 6*z*z00^2 - 12*n*x^2*y00*z^4 + 6*x^2*y*z - 72*n*x^2*y00*z^3 - 108*x*z^2 + 6*n*x^2*z^3*z00^2 - z^3*z00^2 - n*x^2*z^3*z00^3 + 18*n*x^2*y00*z^3*z00 - 6*x^2*z00^2 + x^2*z00^3 - 108*x00*z - 6*n*x^2*z^4*z00 + z^2*z00^3 - 5*z^2*z00^2 + 6*z^3*z00 - 108*n*x^2*x00*z^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 12 y00 (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ x y) (+ x y) (+ z 6) z00) (* 108 (+ x y) (+ z 6)) (* 60 y00 (+ z 6) (+ z 6))) (* 108 (+ x y) (+ x y) (+ x y)) (* 78 (+ y z) (+ z 6) (+ z 6))) (* 6 (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 18 y00 (+ z 6) (+ z 6) z00) (* 72 y00 (+ z 6))) (* 108 x00 (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ z 6) z00 z00) (* 6 (+ z 6) (+ z 6) z00)) (* 72 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 72 (+ x y) (+ x y) (+ y z)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 18 (+ x y) (+ x y) y00 z00)) (* 18 y00 (+ z 6) z00) (* 72 (+ y z) (+ z 6)) (* 12 (+ x y) (+ x y) y00 (+ z 6)) (* 108 (+ x y) (+ x y) x00) (* 72 (+ x y) (+ x y) y00)) (* (+ z 6) z00 z00 z00)) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ z 6) z00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ x y) (+ x y) (+ y z) (+ z 6))) (* 72 (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6)) (* 108 (+ x y) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* (+ z 6) (+ z 6) (+ z 6) z00 z00) (* (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00)) (* 18 (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 (+ x y) (+ x y) z00 z00)) (* (+ x y) (+ x y) z00 z00 z00)) (* 108 x00 (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00)) (* (+ z 6) (+ z 6) z00 z00 z00)) (* 5 (+ z 6) (+ z 6) z00 z00)) (* 6 (+ z 6) (+ z 6) (+ z 6) z00)) (* 108 (+ n 1) (+ x y) (+ x y) x00 (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
