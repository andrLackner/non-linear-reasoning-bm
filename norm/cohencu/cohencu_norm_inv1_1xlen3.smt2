...
; Benchmark: 		cohencu_norm_inv1_1xlen3
...
; Testing invariant: -6*n^4*z^3 - 6*n^4*x*y*z^3 - n^3*x*y*z^2*z00 + 6*n^3*n00*z^3 - 6*n^4*x*y*z^2 + 6*n^3*n00*x*y*z^3 + 6*n^3*n00*x*y*z^2 - n^3*z^3*z00 + n^3*z^4 + n^3*x*y*z^4 + n^3*x*y*z^3 - n^3*x*y*z^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (* (- 6) (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
