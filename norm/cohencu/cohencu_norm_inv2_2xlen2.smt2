...
; Benchmark: 		cohencu_norm_inv2_2xlen2
...
; Testing invariant: -n^4*x^4*y^2*z^3*z00^2 - 12*n^4*x^6*y00*z^2 - n^4*x^6*z^4 + 6*n^4*x^6*z^3 + n^4*x^5*z^2 - 6*n^4*x^5*z - 12*n^4*x^5*y + 12*n^4*x^5*y00 + n^4*x^3*y^2*z*z00^2 + 6*n^4*x^5*z00 - 12*n^4*x^4*y^3*z^3 + 12*n^4*x^4*y^2*y00*z^3 + 12*n^4*x^6*y*z^2 + n^4*x^4*y^2*z^5 - 6*n^4*x^4*y^2*z^4 - n^4*x^3*y^2*z^3 - 12*n^4*x^3*y^2*y00*z + 6*n^4*x^3*y^2*z^2 + 12*n^4*x^3*y^3*z - 6*n^4*x^6*z^2*z00 - n^4*x^5*z00^2 + 6*n^4*x^4*y^2*z^3*z00 - 6*n^4*x^3*y^2*z*z00 + n^4*x^6*z^2*z00^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 1) (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) y00 (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) y00) (* (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) z00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00 z00)) 0))
			)
		)
	)
)
