...
; Benchmark: 		cohencu_norm_inv3_1xlen3
...
; Testing invariant: 6*x*y^2*z*z00^2 - x*y^2*z*z00^3 + 6*n^2*x*y^2*z^3*z00^2 - n^2*x*y^2*z^3*z00^3 - 72*x*y^2*y00*z + 12*n*y00*z - 108*n*x - 72*n*y + 108*n^2*x^2*y^2*z^3 + 6*n*y*z - 6*n^2*x*y^2*z^4*z00 - 6*x*y^3*z^2 + 108*x^2*y^2*z - 72*n^2*x*y^2*y00*z^3 - 12*n^2*x*y^2*y00*z^4 + 18*x*y^2*y00*z*z00 - 6*x*y^2*z^2*z00 - 6*n*z00^2 + 72*n^2*x*y^3*z^3 + n*z00^3 - n*z*z00^2 + 6*n*z*z00 - 12*x*y^2*y00*z^2 - 18*n*y00*z00 - 6*n^2*x*y^3*z^4 + n^2*x*y^2*z^4*z00^2 - 108*n^2*x*x00*y^2*z^3 - 108*x*x00*y^2*z + 72*x*y^3*z + 72*n*y00 + 18*n^2*x*y^2*y00*z^3*z00 + 108*n*x00 + x*y^2*z^2*z00^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* 6 (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00) (* (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00 z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00) (* 72 (+ x y) (+ y z) (+ y z) y00 (+ z 6))) (* 12 (+ n 1) y00 (+ z 6))) (* 108 (+ n 1) (+ x y)) (* 72 (+ n 1) (+ y z))) (* 108 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 108 (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* 72 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 18 (+ x y) (+ y z) (+ y z) y00 (+ z 6) z00)) (* 6 (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) z00 z00)) (* 72 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) z00 z00 z00)) (* (+ n 1) (+ z 6) z00 z00)) (* 6 (+ n 1) (+ z 6) z00)) (* 12 (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 18 (+ n 1) y00 z00) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 108 (+ n 1) (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 108 (+ x y) x00 (+ y z) (+ y z) (+ z 6))) (* 72 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 72 (+ n 1) y00) (* 18 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) z00) (* 108 (+ n 1) x00) (* (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) 0))
			)
		)
	)
)
