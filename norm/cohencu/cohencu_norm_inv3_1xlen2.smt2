...
; Benchmark: 		cohencu_norm_inv3_1xlen2
...
; Testing invariant: -n*y*z^4*z00^2 - 72*n*y^2*z^2 + 84*n*y*y00*z^3 - 108*n*x*y*z^3 + 72*n*y*y00*z^2 - 6*n*y*z^2*z00^2 + 12*n*y*y00*z^4 + n*y*z^2*z00^3 + 108*n*x00*y*z^2 - 18*n*y*y00*z^2*z00 + 108*n*x00*y*z^3 - 18*n*y*y00*z^3*z00 - 108*n*x*y*z^2 + 6*n*y^2*z^4 - 66*n*y^2*z^3 + 6*n*y*z^4*z00 + n*y*z^3*z00^3 + 6*n*y*z^3*z00 - 7*n*y*z^3*z00^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 1) (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 72 (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 84 (+ n 1) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6))) (* 108 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ y z) y00 (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ y z) (+ z 6) (+ z 6) z00 z00 z00) (* 108 (+ n 1) x00 (+ y z) (+ z 6) (+ z 6))) (* 18 (+ n 1) (+ y z) y00 (+ z 6) (+ z 6) z00)) (* 108 (+ n 1) x00 (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 18 (+ n 1) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) z00) (* 108 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 66 (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00) (* 6 (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 7 (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) 0))
			)
		)
	)
)
