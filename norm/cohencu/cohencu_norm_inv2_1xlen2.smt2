...
; Benchmark: 		cohencu_norm_inv2_1xlen2
...
; Testing invariant: -z00^2 - n*x^3*y*z00^2 + 12*n*x^3*y*y00 - 12*n*x^3*y^2 + 12*y00 + n*x^3*y*z^2 - 12*y - 6*z - 6*n*x^3*y*z + 6*z00 + 6*n*x^3*y*z00 + z^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (* (- 1) z00 z00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) z00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) (* 12 y00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ y z)) (* 6 (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6))) (* 6 z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) z00) (* (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
