...
; Benchmark: 		cohencu_norm_inv2_1xlen3
...
; Testing invariant: -12*n*x^2*y^3*y00 - 12*n^3*x*y^3*z^3 - 6*n*x^2*y^3*z00 + 12*n*x*y^4 - n^3*x*y^2*z^3*z00^2 + n*x*y^3*z00^2 + 6*n*x^2*y^3*z - n*x*y^3*z^2 + 12*n*x^2*y^4 - 6*n^3*x*y^2*z^4 + n^3*x*y^2*z^5 + n*x^2*y^3*z00^2 + 6*n^3*x*y^2*z^3*z00 - n*x^2*y^3*z^2 + 12*n^3*x*y^2*y00*z^3 - 12*n*x*y^3*y00 - 6*n*x*y^3*z00 + 6*n*x*y^3*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 12) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) z00 z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00 z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
