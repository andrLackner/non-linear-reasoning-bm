...
; Benchmark: 		cohencu_norm_inv1_1xlen4
...
; Testing invariant: -6*n*n00*x^3*y^2*z^3 + 6*n^2*x^3*y^2*z^3 - 6*n00*x^2*y^3*z^2 - n*x^3*y^2*z^4 + x*z*z00 - x*z^2 + n^2*x^3*y^3*z00 - 6*n^2*n00*x^3*y^3 + 6*n*x*z - n^2*x^3*y^3*z - 6*n00*x*z + 6*n*x^2*y^3*z^2 - x^2*y^3*z^3 + n*x^3*y^2*z^3*z00 + 6*n^3*x^3*y^3 + x^2*y^3*z^2*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ z 6) z00)) (* (+ x y) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z))) (* 6 (+ n 1) (+ x y) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 6 n00 (+ x y) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z)) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
