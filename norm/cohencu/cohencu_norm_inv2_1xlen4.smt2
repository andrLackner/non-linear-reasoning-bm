...
; Benchmark: 		cohencu_norm_inv2_1xlen4
...
; Testing invariant: n^3*x*y^3*z^3 - 6*n^3*x*y^3*z^2 + 12*n^3*x^2*y^2*z^2 - 12*n^3*x*y^4*z + 6*n^3*x^2*y*z^3 - n^3*x*y^3*z*z00^2 - 12*x*y^3*y00 + x^3*z^4 - 6*x^3*z^3 + n^3*x^2*y*z^2*z00^2 - x^3*z^2*z00^2 - 12*n^3*x^2*y*y00*z^2 + 6*x^3*z^2*z00 + 12*x*y^4 - 6*x*y^3*z00 + 12*n^3*x*y^3*y00*z - x*y^3*z^2 + 12*x^3*y00*z^2 + 6*n^3*x*y^3*z*z00 + 6*x*y^3*z + x*y^3*z00^2 - 12*x^3*y*z^2 - n^3*x^2*y*z^4 - 6*n^3*x^2*y*z^2*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00) (* 12 (+ x y) (+ y z) (+ y z) (+ y z) y00)) (* (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00 z00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6))) (* 6 (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00) (* 12 (+ x y) (+ y z) (+ y z) (+ y z) (+ y z))) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6))) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ x y) (+ x y) (+ x y) y00 (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ x y) (+ y z) (+ y z) (+ y z) z00 z00)) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
