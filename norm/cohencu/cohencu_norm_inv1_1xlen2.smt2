...
; Benchmark: 		cohencu_norm_inv1_1xlen2
...
; Testing invariant: -n*y^3*z^3*z00 + 6*n00*x^2*z^3 + 6*n*n00*y^3*z^3 - x^2*z^3*z00 - 6*n*x^2*z^3 + n*y^3*z^4 + x^2*z^4 - 6*n^2*y^3*z^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (* (- 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 n00 (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) n00 (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
