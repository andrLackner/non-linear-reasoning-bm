...
; Benchmark: 		freire2_norm_inv1_1xlen3
...
; Testing invariant: r^3*s^3*s00*x^2 + 3*r*r00^2*x^2 + r^2*s*s00*x^3 + 3*r^4*s*x^3 - 3*r^2*r00^2*s*x^3 - r^3*s^4*x^2 - r*s00*x^2 + r*s*x^2 + 3*r^5*s^3*x^2 - 3*r^3*x^2 - r^2*s^2*x^3 - 3*r^3*r00^2*s^3*x^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 3 (+ r 1) r00 r00 (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) s00 (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) 0))
			)
		)
	)
)
