...
; Benchmark: 		freire2_norm_inv1_1xlen2
...
; Testing invariant: -3*r^2*s^2*x + 3*r^3*x - s^2*s00*x + s^3*x - r*s*x + r*s00*x + 3*r00^2*s^2*x - 3*r*r00^2*x
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (* (- 3) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (- x s))) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s))) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (- x s))) (* (+ r 1) s00 (- x s)) (* 3 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) (* 3 (+ r 1) r00 r00 (- x s))) 0))
			)
		)
	)
)
