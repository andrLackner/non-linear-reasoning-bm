...
; Benchmark: 		freire2_norm_inv2_1xlen3
...
; Testing invariant: -4*r^3*s00 - 3*s^3*s00*x^2 - 6*r*s^2*x^3*x00 - 3*r^3 - 6*s^3*x^3 - 6*r^2*x - 12*r^2*r00^2*s^2*x^3 + 6*r00*s^3*s00*x^2 - 12*r00^3*s^3*x^2 + 3*r^2*s^2*x^3 + 6*r*s^2*x^4 + 3*r^2*s - 2*r*s^4*x^2 + 3*r*s^2*s00*x^3 - 3*r^2*s00 + 3*s^4*x^2 + 6*s^3*x^2*x00 + 3*r^2*r00 + 6*r^2*r00*s00 + 12*r*r00^3*s^2*x^3 + 2*r^2*s^3*x^3 + 3*r00*s^3*x^2 + 12*r^3*r00^2 + 12*r*r00^2*s^3*x^2 + 4*r^2*s^2*s00*x^3 - 3*r*r00*s^2*x^3 - 4*r*s^3*s00*x^2 - 2*r^3*s - 6*r*r00*s^2*s00*x^3 - 3*r*s^3*x^3 - 12*r^2*r00^3 - 3*r*s^3*x^2 + 6*r^2*x00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 4) (+ r 1) (+ r 1) (+ r 1) s00) (* 3 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 6 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) x00) (* 3 (+ r 1) (+ r 1) (+ r 1)) (* 6 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) (- x s)) (* 12 (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 6 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s))) (* 12 r00 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 6 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (* 2 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) s00)) (* 3 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* 6 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) x00) (* 3 (+ r 1) (+ r 1) r00) (* 6 (+ r 1) (+ r 1) r00 s00) (* 12 (+ r 1) r00 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 2 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 3 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* 12 (+ r 1) (+ r 1) (+ r 1) r00 r00) (* 12 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* 4 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 3 (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 4 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3)) (* 6 (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 12 (+ r 1) (+ r 1) r00 r00 r00) (* 3 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 6 (+ r 1) (+ r 1) x00)) 0))
			)
		)
	)
)
