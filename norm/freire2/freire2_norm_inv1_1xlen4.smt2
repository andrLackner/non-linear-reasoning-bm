...
; Benchmark: 		freire2_norm_inv1_1xlen4
...
; Testing invariant: -r*s^3 - 3*r^2*r00^2*s^3 - 3*r^2 + 3*r^3*s^2*x - 3*r*r00^2*s^2*x - 3*r*r00^2*s^2 - r^2*s^4 + 3*r^3*s^2 + 3*r^4*s^3 - s00 + r^2*s^3*s00 + s + r*s^2*s00*x + r*s^2*s00 + 3*r00^2 - r*s^3*x
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (* (- 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) s00) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00) s (* 6 r) 3 (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00) (* 3 r00 r00)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) 0))
			)
		)
	)
)
