...
; Benchmark: 		freire2_norm_inv3_1xlen2
...
; Testing invariant: 2*s^3*s00*x^3 - 18*r*s^2*x^3*x00 - 6*r*r00^2*s*s00*x^3 + 18*r00*s^2*x^4 + 3*s^3*x^3 + 9*r^2*s^2*x^3 + 6*r*r00^2*s^2*x^3 + 9*r00*s^2*s00*x^3 + 3*r*s*s00*x^3 - 3*r*s^2*x^3 - 18*r00*s^2*x^3*x00 + 18*r*s^2*x^4 + 6*r*r00*s^3*x^3 - 6*r00^2*s^3*x^3 - 9*r*r00*s*s00*x^3 - 9*r^2*s*s00*x^3 + 4*r*s*s00^2*x^3 - 3*s^2*s00*x^3 - 6*r^2*r00*s^2*x^3 + 7*r*s^2*s00*x^3 - 18*r^2*s*x^4 + 2*s^4*x^3 + 6*r^2*r00*s*s00*x^3 - 9*r00*s^3*x^3 + 6*r00^2*s^2*s00*x^3 + 18*r*r00*s*x^3*x00 - 18*r*r00*s*x^4 + 9*r*r00*s^2*x^3 - 6*r*r00*s^2*s00*x^3 - 4*s^2*s00^2*x^3 - 11*r*s^3*x^3 + 18*r^2*s*x^3*x00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* 2 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 18 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) x00) (* 6 (+ r 1) r00 r00 (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 18 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s)) (* 3 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 9 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 6 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 9 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 18 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) x00)) (* 18 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s)) (* 6 (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 6 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 9 (+ r 1) r00 (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 9 (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 4 (+ r 1) (+ s (* 6 r) 3) s00 s00 (- x s) (- x s) (- x s))) (* 3 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 7 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 18 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s))) (* 2 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 9 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 6 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 18 (+ r 1) r00 (+ s (* 6 r) 3) (- x s) (- x s) (- x s) x00)) (* 18 (+ r 1) r00 (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s))) (* 9 (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 6 (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 4 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 s00 (- x s) (- x s) (- x s)) (* 11 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 18 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) x00)) 0))
			)
		)
	)
)
