...
; Benchmark: 		freire2_norm_inv1_2xlen2
...
; Testing invariant: 3*r*r00^2*x^2 - 3*r*r00^2*x^4 + 3*r^3*s^3*x^3 - r*s^3*s00*x^5 - 3*r^3*s^3*x^5 + r*s^3*s00*x^3 + 3*r^3*x^4 - 3*r^3*x^2 + 3*r*r00^2*s^3*x^5 - 3*r*r00^2*s^3*x^3 - r*s*x^4 + r*s^4*x^5 + r*s00*x^4 - r*s00*x^2 + r*s*x^2 - r*s^4*x^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (* 3 (+ r 1) r00 r00 (- x s) (- x s)) (* 3 (+ r 1) r00 r00 (- x s) (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (- x s) (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (- x s) (- x s))) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s) (- x s))) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s) (- x s)) (* (+ r 1) s00 (- x s) (- x s) (- x s) (- x s))) (* (+ r 1) s00 (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) 0))
			)
		)
	)
)
