...
; Benchmark: 		freire2_norm_inv2_1xlen2
...
; Testing invariant: -3*r^2*s*s00 - 3*r*r00*x + 3*r^2*r00*s + 3*r^2*x + 4*r^2*s00*x + 12*r*r00^3*x - 6*r*r00*s00*x + 3*r*s00*x + 3*r^2*s^2 - 6*r*x*x00 - 2*r^3*s^2 + 6*r*x^2 + 6*r^2*s*x00 - 12*r^2*r00^3*s - 4*r^3*s*s00 + 6*r^2*r00*s*s00 - 3*r*s*x - 3*r^3*s - 4*r^2*s*x - 12*r^2*r00^2*x + 12*r^3*r00^2*s
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 3) (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00) (* 3 (+ r 1) r00 (- x s))) (* 3 (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1) (- x s)) (* 4 (+ r 1) (+ r 1) s00 (- x s)) (* 12 (+ r 1) r00 r00 r00 (- x s))) (* 6 (+ r 1) r00 s00 (- x s))) (* 3 (+ r 1) s00 (- x s)) (* 3 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 6 (+ r 1) (- x s) x00) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 6 (+ r 1) (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) (+ s (* 6 r) 3) x00)) (* 12 (+ r 1) (+ r 1) r00 r00 r00 (+ s (* 6 r) 3)) (* 4 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00)) (* 6 (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) s00)) (* 3 (+ r 1) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3)) (* 4 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s)) (* 12 (+ r 1) (+ r 1) r00 r00 (- x s))) (* 12 (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3))) 0))
			)
		)
	)
)
