...
; Benchmark: 		cohencu_denorm_inv5_4xlen1
...
; Testing invariant: (-18*x00*y00 - 18*x*y - 18*x*z - 3*x*z00^2 - y00^2*z00 + 3*x00*z*z00 - y*y00*z00 + 12*y00*z - 6*y00*z00 + 36*y*y00 + 6*y*z00 - 12*y*z - 3*x*z*z00 + 2*y^2*z00 - 36*y00^2 + 18*x00*z + y^2*z + 18*x00*y + 3*x00*z00^2 + 108*x - 72*y00 + 18*x*y00 + 72*y - 108*x00 + y*y00*z + 3*y00*z00^2 - 2*y00^2*z - 3*y*z00^2) * (n*x^2*z^2) * (-n*x^3*y^3) * (-n^3*x*y^2*z^3) * (n^3*x^3*y^3*z^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 18) x00 y00) (* 18 (+ x y) (+ y z)) (* 18 (+ x y) (+ z 6)) (* 3 (+ x y) z00 z00) (* y00 y00 z00)) (* 3 x00 (+ z 6) z00)) (* (+ y z) y00 z00)) (* 12 y00 (+ z 6))) (* 6 y00 z00)) (* 36 (+ y z) y00) (* 6 (+ y z) z00)) (* 12 (+ y z) (+ z 6)) (* 3 (+ x y) (+ z 6) z00)) (* 2 (+ y z) (+ y z) z00)) (* 36 y00 y00)) (* 18 x00 (+ z 6)) (* (+ y z) (+ y z) (+ z 6)) (* 18 x00 (+ y z)) (* 3 x00 z00 z00) (* 108 (+ x y))) (* 72 y00)) (* 18 (+ x y) y00) (* 72 (+ y z))) (* 108 x00)) (* (+ y z) y00 (+ z 6)) (* 3 y00 z00 z00)) (* 2 y00 y00 (+ z 6)) (* 3 (+ y z) z00 z00)) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (- 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (- 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) 0))
			)
		)
	)
)
