...
; Benchmark: 		cohencu_denorm_inv4_4xlen1
...
; Testing invariant: (-y00*z*z00 - 12*y*z - 18*x*z + 18*x00*z00 + 12*y^2 - 24*y00^2 + 18*x00*z + 12*y00*z + 6*y00*z00 + 12*y*y00 + 108*x - 72*y00 - 6*y*z00 + 72*y - 108*x00 + y00*z00^2 - 18*x*z00 + y*z*z00 - y*z00^2) * (-n^2*x^3*y*z^3) * (n^3*y*z) * (-n^3) * (-n^2*x^2*y^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 1) y00 (+ z 6) z00) (* 12 (+ y z) (+ z 6)) (* 18 (+ x y) (+ z 6))) (* 18 x00 z00) (* 12 (+ y z) (+ y z))) (* 24 y00 y00)) (* 18 x00 (+ z 6)) (* 12 y00 (+ z 6)) (* 6 y00 z00) (* 12 (+ y z) y00) (* 108 (+ x y))) (* 72 y00) (* 6 (+ y z) z00)) (* 72 (+ y z))) (* 108 x00)) (* y00 z00 z00)) (* 18 (+ x y) z00)) (* (+ y z) (+ z 6) z00)) (* (+ y z) z00 z00)) (- 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ z 6) (- 1) (+ n 1) (+ n 1) (+ n 1) (- 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z)) 0))
			)
		)
	)
)
