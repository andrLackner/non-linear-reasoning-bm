...
; Benchmark: 		cohencu_denorm_inv1_3xlen1
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (n*x^2*y^2) * (-n^3*x^3*y^2) * (n^3*x^2*z^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (- 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) 0))
			)
		)
	)
)
