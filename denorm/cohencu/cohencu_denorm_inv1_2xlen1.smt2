...
; Benchmark: 		cohencu_denorm_inv1_2xlen1
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-n*z^3) * (n*x^3*y^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z)) 0))
			)
		)
	)
)
