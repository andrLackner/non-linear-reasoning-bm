...
; Benchmark: 		cohencu_denorm_inv1_3xlen2
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (n^3*x^2 - n^3*x^3*y*z^3) * (n^3*x*z^2 - n*x^2) * (-n^3*x^3*y^3*z - n^2*x^3*z^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (- (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y))) (- (* (- 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
