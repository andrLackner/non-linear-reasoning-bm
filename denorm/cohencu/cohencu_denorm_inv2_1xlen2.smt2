...
; Benchmark: 		cohencu_denorm_inv2_1xlen2
...
; Testing invariant: (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2) * (n*x*y*z^3 + y^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6))) (+ (* (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ y z) (+ y z)))) 0))
			)
		)
	)
)
