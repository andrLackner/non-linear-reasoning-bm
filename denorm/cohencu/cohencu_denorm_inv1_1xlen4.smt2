...
; Benchmark: 		cohencu_denorm_inv1_1xlen4
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (n^2*x^2*y^2*z - n^2*x*z^2 - n*x*y^3*z^3 - z^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ z 6) (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
