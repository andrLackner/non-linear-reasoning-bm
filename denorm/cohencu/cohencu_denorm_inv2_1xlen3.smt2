...
; Benchmark: 		cohencu_denorm_inv2_1xlen3
...
; Testing invariant: (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2) * (n*y^2*z^2 + n^2*y*z + n^3*y^2*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6))) (+ (* (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6)))) 0))
			)
		)
	)
)
