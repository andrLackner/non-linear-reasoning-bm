...
; Benchmark: 		cohencu_denorm_inv1_2xlen3
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-n^2*x^2*y^3*z - n^3*x^3*y - x^2*y^3) * (-n^3*x*y^3*z^2 - n*x*z^2 - n^3*x*y*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (* (- 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z)) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ y z))) (- (* (- 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6)))) 0))
			)
		)
	)
)
