...
; Benchmark: 		cohencu_denorm_inv2_3xlen1
...
; Testing invariant: (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2) * (n^2*x*y^3*z^3) * (n^2*x*y^3*z^3) * (n*x^2*y^2*z^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6))) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) 0))
			)
		)
	)
)
