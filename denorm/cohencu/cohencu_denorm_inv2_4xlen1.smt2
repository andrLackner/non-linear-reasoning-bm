...
; Benchmark: 		cohencu_denorm_inv2_4xlen1
...
; Testing invariant: (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2) * (-n*x*z^2) * (y^2) * (-n^2*x*z^3) * (-n^2*x^2*y*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6))) (- 1) (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ y z) (+ y z) (- 1) (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (- 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6)) 0))
			)
		)
	)
)
