...
; Benchmark: 		cohencu_denorm_inv1_1xlen2
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-n*y^2*z^2 - x^2*y^2*z^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (* (- 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
