...
; Benchmark: 		cohencu_denorm_inv3_3xlen1
...
; Testing invariant: (-6*y*z - z00^3 + 6*z00^2 - 12*y00*z + 18*y00*z00 + 108*x - 72*y00 - 6*z*z00 + 72*y - 108*x00 + z*z00^2) * (n^3*x^3*y^2*z^3) * (-n^2*x*y^3*z) * (n*x*y*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (- (+ (- (+ (- (+ (- (* (- 6) (+ y z) (+ z 6)) (* z00 z00 z00)) (* 6 z00 z00)) (* 12 y00 (+ z 6))) (* 18 y00 z00) (* 108 (+ x y))) (* 72 y00) (* 6 (+ z 6) z00)) (* 72 (+ y z))) (* 108 x00)) (* (+ z 6) z00 z00)) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (- 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ n 1) (+ x y) (+ y z) (+ z 6)) 0))
			)
		)
	)
)
