...
; Benchmark: 		cohencu_denorm_inv6_2xlen1
...
; Testing invariant: (216*x00*y00 + 108*x*y + 36*x00*z00 - 2*x*z00^3 + 18*x*z00^2 - 12*y00^2*z00 - y00^2*z00^2 + 24*y^2 + 108*x^2 - 4*y^3 + 18*y*y00*z00 + 24*y00*z00 - 120*y*y00 - 24*y*z00 + 16*y00^3 - 6*y^2*z00 + 96*y00^2 - 12*y^2*y00 - 36*x00*y00*z00 - 108*x00*y - 18*x00*z00^2 - 216*x*x00 + y00*z00^3 + 2*x00*z00^3 - 216*x*y00 + y^2*z00^2 - 10*y00*z00^2 - 36*x*z00 + 36*x*y00*z00 + 10*y*z00^2 + 108*x00^2 - y*z00^3) * (-n^3*x^2*y^3*z^2) * (-n^2*y*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 216 x00 y00) (* 108 (+ x y) (+ y z)) (* 36 x00 z00)) (* 2 (+ x y) z00 z00 z00)) (* 18 (+ x y) z00 z00)) (* 12 y00 y00 z00) (* y00 y00 z00 z00)) (* 24 (+ y z) (+ y z)) (* 108 (+ x y) (+ x y))) (* 4 (+ y z) (+ y z) (+ y z))) (* 18 (+ y z) y00 z00) (* 24 y00 z00)) (* 120 (+ y z) y00) (* 24 (+ y z) z00)) (* 16 y00 y00 y00)) (* 6 (+ y z) (+ y z) z00)) (* 96 y00 y00)) (* 12 (+ y z) (+ y z) y00) (* 36 x00 y00 z00) (* 108 x00 (+ y z)) (* 18 x00 z00 z00) (* 216 (+ x y) x00)) (* y00 z00 z00 z00) (* 2 x00 z00 z00 z00)) (* 216 (+ x y) y00)) (* (+ y z) (+ y z) z00 z00)) (* 10 y00 z00 z00) (* 36 (+ x y) z00)) (* 36 (+ x y) y00 z00) (* 10 (+ y z) z00 z00) (* 108 x00 x00)) (* (+ y z) z00 z00 z00)) (- 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (- 1) (+ n 1) (+ n 1) (+ y z) (+ z 6)) 0))
			)
		)
	)
)
