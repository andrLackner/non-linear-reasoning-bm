...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (* (- 1) (/ b 2) d00) (* b00 (/ d 2))) (+ (* (- 1) a (/ b 2)) (* a (/ b 2) (/ b 2) (/ b 2) (/ d 2) (/ d 2) (/ d 2)))) 0))
				(not (= (* (+ (* (- 1) (/ b 2) d00) (* b00 (/ d 2))) (+ (* (- 1) (+ a b) (/ b 2)) (* (+ a b) (/ b 2) (/ b 2) (/ b 2) (/ d 2) (/ d 2) (/ d 2)))) 0))
			)
		)
	)
)
