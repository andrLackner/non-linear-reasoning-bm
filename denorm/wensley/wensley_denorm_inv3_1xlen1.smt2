...
; Benchmark: 		wensley_denorm_inv3_1xlen1
; Created:   		2022-01-11 18:16
; Generator of the ideal: 
; 		 -2*b00*y00 + a00*d00 + 2*b00*y - a*d00
; 		 -b*d00 + b00*d
; 		 a*d - 2*b*y + 2*b*y00 - a00*d
; Testing invariant: (a*d - 2*b*y + 2*b*y00 - a00*d) * (-a*b^2*d)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- (* a (/ d 2)) (* 2 (/ b 2) y)) (* 2 (/ b 2) y00)) (* a00 (/ d 2))) (- 1) a (/ b 2) (/ b 2) (/ d 2)) 0))
				(not (= (* (- (+ (- (* (+ a b) (/ d 2)) (* 2 (/ b 2) (+ y (/ d 2)))) (* 2 (/ b 2) y00)) (* a00 (/ d 2))) (- 1) (+ a b) (/ b 2) (/ b 2) (/ d 2)) 0))
			)
		)
	)
)
