...
; Benchmark: 		cubes_denorm_inv4_1xlen2
...
; 		 1 - 3*c + k*n - k + 2*n
; 		 1 + 3*n^2 - k + 3*n
; Testing invariant: (1 + 3*n^2 - k + 3*n) * (c^3*k^3*m + k*m*n^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (- (+ 1 (* 3 (+ n 1) (+ n 1))) (+ k m)) (* 3 (+ n 1))) (+ (* (+ c k) (+ c k) (+ c k) (+ k m) (+ k m) (+ k m) (+ m 6)) (* (+ k m) (+ m 6) (+ n 1) (+ n 1) (+ n 1)))) 0))
			)
		)
	)
)
