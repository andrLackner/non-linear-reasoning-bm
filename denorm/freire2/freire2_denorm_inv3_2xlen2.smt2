...
; Benchmark: 		freire2_denorm_inv3_2xlen2
...
; Testing invariant: (-9*r*s - 18*r00*x00 + 9*r00*s00 + 2*s^2 + 18*r*x + 6*r*r00*s - 6*r00^2*s - 4*s00^2 + 18*r00*x - 3*s00 + 6*r00^2*s00 - 18*r*x00 + 3*s + 9*r*s00 + 2*s*s00 - 9*r00*s - 6*r*r00*s00) * (-r^3*s*x^2 - r*s^3*x) * (s^2 + r^2*x^2)
;--------------------------------------------------------------------------
