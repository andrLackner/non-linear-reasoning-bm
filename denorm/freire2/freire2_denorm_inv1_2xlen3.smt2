...
; Benchmark: 		freire2_denorm_inv1_2xlen3
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (r^3*s^2*x^2 + s^2*x^2 + r^2*s) * (-r^3*s^3*x^2 + r*s*x - r^2*s^3*x^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (+ (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (- (+ (* (- 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (- x s))) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)))) 0))
			)
		)
	)
)
