...
; Benchmark: 		freire2_denorm_inv1_3xlen1
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (-r^3*s^2*x^3) * (r*s*x) * (r^3*s^2*x^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (- 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (+ r 1) (+ s (* 6 r) 3) (- x s) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) 0))
			)
		)
	)
)
