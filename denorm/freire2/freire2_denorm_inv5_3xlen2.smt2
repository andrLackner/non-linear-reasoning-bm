...
; Benchmark: 		freire2_denorm_inv5_3xlen2
...
; Testing invariant: (216*r00*s00*x00 + 108*r00*x00 - 54*r00*s00 + 15*s^2 - 216*r00^3*s - 36*r00^2*s00^2 - 4*s^3 + 108*x^2 - 432*r00^3*x00 - 12*s^2*s00 + 108*s00*x - 108*r00*s00^2 + 216*r00^3*s00 + 108*s*x00 + 432*r00^3*x - 66*s*s00 + 108*r00*s*s00 - 108*s00*x00 - 216*r00*s00*x + 36*r00^2*s^2 + 16*s00^3 - 108*s*x + 36*r00^2*s + 51*s00^2 - 108*r00*x + 9*s00 - 36*r00^2*s00 - 9*s + 54*r00*s - 216*x*x00 + 108*x00^2) * (-r*s - r) * (r^2*s^3*x^2 - r^3*s) * (-r*s*x + r^2*s)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 216 r00 s00 x00) (* 108 r00 x00)) (* 54 r00 s00)) (* 15 (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 216 r00 r00 r00 (+ s (* 6 r) 3)) (* 36 r00 r00 s00 s00) (* 4 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 108 (- x s) (- x s))) (* 432 r00 r00 r00 x00) (* 12 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00)) (* 108 s00 (- x s))) (* 108 r00 s00 s00)) (* 216 r00 r00 r00 s00) (* 108 (+ s (* 6 r) 3) x00) (* 432 r00 r00 r00 (- x s))) (* 66 (+ s (* 6 r) 3) s00)) (* 108 r00 (+ s (* 6 r) 3) s00)) (* 108 s00 x00) (* 216 r00 s00 (- x s))) (* 36 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 16 s00 s00 s00)) (* 108 (+ s (* 6 r) 3) (- x s))) (* 36 r00 r00 (+ s (* 6 r) 3)) (* 51 s00 s00)) (* 108 r00 (- x s))) (* 9 s00)) (* 36 r00 r00 s00) (* 9 (+ s (* 6 r) 3))) (* 54 r00 (+ s (* 6 r) 3))) (* 216 (- x s) x00)) (* 108 x00 x00)) (- (* (- 1) (+ r 1) (+ s (* 6 r) 3)) (+ r 1)) (- (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (+ (* (- 1) (+ r 1) (+ s (* 6 r) 3) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3)))) 0))
			)
		)
	)
)
