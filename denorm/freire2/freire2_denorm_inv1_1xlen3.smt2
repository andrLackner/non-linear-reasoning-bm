...
; Benchmark: 		freire2_denorm_inv1_1xlen3
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (x - r^2*s^3*x^3 - s^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (- x s (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)))) 0))
			)
		)
	)
)
