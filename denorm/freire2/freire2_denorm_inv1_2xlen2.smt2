...
; Benchmark: 		freire2_denorm_inv1_2xlen2
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (-r^3*s*x^3 - x) * (r^3*s^3*x^2 + x)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (- (* (- 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) x s) (+ (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (- x s))) 0))
			)
		)
	)
)
