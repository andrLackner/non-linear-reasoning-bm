...
; Benchmark: 		freire2_denorm_inv1_1xlen4
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (-r^2*s^2*x - s - r*x - r^2*x^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (- (* (- 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (+ s (* 6 r) 3) (* (+ r 1) (- x s)) (* (+ r 1) (+ r 1) (- x s) (- x s) (- x s)))) 0))
			)
		)
	)
)
