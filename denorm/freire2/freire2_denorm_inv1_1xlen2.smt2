...
; Benchmark: 		freire2_denorm_inv1_1xlen2
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (r*x + r^3*s^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (+ (* (+ r 1) (- x s)) (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)))) 0))
			)
		)
	)
)
