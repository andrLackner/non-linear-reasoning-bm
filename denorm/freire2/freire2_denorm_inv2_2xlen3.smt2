...
; Benchmark: 		freire2_denorm_inv2_2xlen3
...
; Testing invariant: (-2*r*s + 12*r*r00^2 - 3*r - 3*s00 + 3*s + 3*r00 - 4*r*s00 + 6*r00*s00 - 6*x + 6*x00 - 12*r00^3) * (-s - s^2*x - r*x^2) * (r^2*s^2*x + r^2*s - r^2*s*x)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- (+ (- (+ (- (+ (* (- 2) (+ r 1) (+ s (* 6 r) 3)) (* 12 (+ r 1) r00 r00)) (* 3 (+ r 1)) (* 3 s00)) (* 3 (+ s (* 6 r) 3)) (* 3 r00)) (* 4 (+ r 1) s00)) (* 6 r00 s00)) (* 6 (- x s))) (* 6 x00)) (* 12 r00 r00 r00)) (- (* (- 1) (+ s (* 6 r) 3)) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* (+ r 1) (- x s) (- x s))) (- (+ (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s)))) 0))
			)
		)
	)
)
