...
; Benchmark: 		freire2_denorm_inv3_1xlen3
...
; Testing invariant: (-9*r*s - 18*r00*x00 + 9*r00*s00 + 2*s^2 + 18*r*x + 6*r*r00*s - 6*r00^2*s - 4*s00^2 + 18*r00*x - 3*s00 + 6*r00^2*s00 - 18*r*x00 + 3*s + 9*r*s00 + 2*s*s00 - 9*r00*s - 6*r*r00*s00) * (-r^3*s*x^3 - r^2*s*x^2 + r*x^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- (+ (- (+ (- (+ (- (* (- 9) (+ r 1) (+ s (* 6 r) 3)) (* 18 r00 x00)) (* 9 r00 s00) (* 2 (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 18 (+ r 1) (- x s)) (* 6 (+ r 1) r00 (+ s (* 6 r) 3))) (* 6 r00 r00 (+ s (* 6 r) 3)) (* 4 s00 s00)) (* 18 r00 (- x s))) (* 3 s00)) (* 6 r00 r00 s00)) (* 18 (+ r 1) x00)) (* 3 (+ s (* 6 r) 3)) (* 9 (+ r 1) s00) (* 2 (+ s (* 6 r) 3) s00)) (* 9 r00 (+ s (* 6 r) 3)) (* 6 (+ r 1) r00 s00)) (+ (- (* (- 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s))) (* (+ r 1) (- x s) (- x s) (- x s)))) 0))
			)
		)
	)
)
