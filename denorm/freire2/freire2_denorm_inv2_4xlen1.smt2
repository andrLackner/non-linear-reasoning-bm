...
; Benchmark: 		freire2_denorm_inv2_4xlen1
...
; Testing invariant: (-2*r*s + 12*r*r00^2 - 3*r - 3*s00 + 3*s + 3*r00 - 4*r*s00 + 6*r00*s00 - 6*x + 6*x00 - 12*r00^3) * (r*s^3*x^2) * (1) * (s*x^3) * (-s^3*x^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- (+ (- (+ (- (+ (* (- 2) (+ r 1) (+ s (* 6 r) 3)) (* 12 (+ r 1) r00 r00)) (* 3 (+ r 1)) (* 3 s00)) (* 3 (+ s (* 6 r) 3)) (* 3 r00)) (* 4 (+ r 1) s00)) (* 6 r00 s00)) (* 6 (- x s))) (* 6 x00)) (* 12 r00 r00 r00)) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) 1 (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) 0))
			)
		)
	)
)
