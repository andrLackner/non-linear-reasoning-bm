...
; Benchmark: 		freire2_denorm_inv1_2xlen1
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (s^2) * (-r^2*s^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) 0))
			)
		)
	)
)
